...
class Message():
    # Format d'un message
    def __init__(self, writer, reader, stamp, type):
        self.writer = writer
        self.reader = reader
        self.stamp = stamp
        self.type = type
...
class NetSite():
    ...
    def send(self, msg):
        ...
        print("envoi d'un message de type,", msg.type,", date logique : ", msg.stamp,", du site ", msg.writer,"au site ", msg.reader)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-neighbors', help = 'name of the other sites in the same network (separated by a comma)', required = True)
